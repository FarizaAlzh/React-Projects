...
// Асинхронный запрос на получение всех товаров
...
// Асинхронный запрос на получение одного товара по ID
...
// Слайс с состоянием для товаров
...
export const { setQuery, setItems } = itemsSlice.actions;
